...
import pglet
from pglet import SpinButton, Stack, Text
        ...
        controls=[
            Stack(
                controls=[
                    ...
                    SpinButton(
                        label="Basic SpinButton:", min=0, max=100, step=1, value=0
                    ),
                    SpinButton(
                        label="SpinButton with label on top:",
                        label_position="top",
                        min=0,
                        max=100,
                        step=1,
